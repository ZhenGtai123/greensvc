...
Description:
    ...
    presence of understory vegetation, hedges, bushes, and ornamental plants in
    the urban landscape. Shrubs provide important ecological services including
    habitat for small wildlife, air quality improvement, noise reduction, and
    aesthetic enhancement. Unlike tree canopy coverage, shrub coverage
    represents ground-level greenery that directly interacts with pedestrians
    and contributes to street-level visual quality.
